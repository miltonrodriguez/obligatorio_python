...
---------------------------------------
A continuación se enumeran las URL de las funcionalidades y una pequeña explicación de las decisiones de desarrollo que se tomaron en cada una de ellas.
...
inventario asociado al ISBN. Falla si no hay copias disponibles o si el socio es moroso.
	...
	-Al prestar, no se coloca la fecha de fin del préstamo, solo se coloca la fecha inicio.
...
levantado vía admin).
	...
	-Al devolver, se calcula la fecha de devolución como fecha_inicio + 7 días. Si el día de hoy es mayor que el día de devolución calculado, se coloca al socio como moroso.
...
fecha).
	-Se hizo en 2 partes:
		...
		2- http://127.0.0.1:8000/biblio/socio/{documento}- información del socio
5. Dado un número de inventario obtener la información del libro y mostrar su estado. Si está
prestado debe desplegarse la info del socio
	-Se hizo en 2 partes:
		1- http://127.0.0.1:8000/biblio/list_copias - tabla de copias con links y filtro
		2-http://127.0.0.1:8000/biblio/copia/{inventario} - información de la copia
...
están disponibles o prestadas).
	-Se hizo en 2 partes:
		...
		2- http://127.0.0.1:8000/biblio/libro/{ISBN} - información del libro
...
devolución (en la fecha actual), pero que debían hacerlo.
	...
	Para esta funcionalidad se hace el mismo calculo que en la devolución.
	Se calcula la fecha de devolución como fecha_inicio + 7 días. 
	Si el día de hoy es mayor que el día de devolución calculado, se coloca al socio en la lista de futuros morosos.
